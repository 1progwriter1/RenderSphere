CFLAGS=-fsanitize=address,alignment -D _DEBUG -ggdb3 -std=c++17 -O3 -Wall -Wextra -Weffc++ -Wc++14-compat -Wmissing-declarations -Wcast-qual \
		...
		-fstack-protector -fstrict-overflow -fno-omit-frame-pointer -fPIE -Werror=vla -DNDEBUG -Wno-unused-parameter
# -Wsuggest-override
